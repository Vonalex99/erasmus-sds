...
export default function DialogSelectCopy(props) {
  ...
  return (
    <div>
      <Button sx={{marginTop: '15px', width: '280px', height: '25px', border: "1px solid #ccc", borderRadius: "9px", fontSize: '10px','&:hover': {
       background: "grey",
    }}} onClick={handleClickOpen}>Click to change course from PUT</Button>
      <Dialog disableEscapeKeyDown open={open} onClose={handleClose} sx={{height: 500 }}>
