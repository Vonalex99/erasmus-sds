    ...
    <div style={{width: '660px', marginTop: "30px"}}>
      ...
      <div style={{display: "flex", justifyContent: "center",height: '78px'}}>
        ...
        <div style={{fontSize: "13px", color: "black", width: '100%'}}>
            ...
            <div style={{display:"flex"}}>Receiving Institution Country<div style={{color:"red"}}>*</div></div>
      ...
      <div style={{display: "flex", justifyContent: "center",height: '78px'}}>
        ...
        <div style={{fontSize: "13px", color: "black", width: '100%'}}>
            ...
            <div style={{display:"flex"}}>Receiving Institution Name<div style={{color:"red"}}>*</div></div>
